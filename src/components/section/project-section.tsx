...
import ProjectCard from "../ui/card-project";
import ShimmerButton from "../magicui/shimmer-button";
import { ProjectModel } from "../../utils/project-model";
import { usePathname } from "next/navigation";

type ProjectsProps = {
  onTotalProjectsChange: (total: number) => void;
};
  ...
  useEffect(() => {
    try {
      ...
      const fetchData = async () => {
        onSnapshot(pathname === "/" ? queries : reff, (document) => {
          console.log(
            "Document Data:",
    ...
    <>
      ...
      >
        ...
        <div className={`w-full flex justify-center`}>
          <ShimmerButton onClick={() => window.open("/projects", "_self")}>
